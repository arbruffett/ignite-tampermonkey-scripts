// ==UserScript==
// @name         prizeweekday.php
// @match        https://beta.rewardsbutler.com/loy/prizeweekday.php*
// @author       arbruffett
// @namespace    https://github.com/arbruffett/ignite-tampermonkey-scripts
// @version      1.0.0
// @downloadURL  https://raw.githubusercontent.com/arbruffett/ignite-tampermonkey-scripts/refs/heads/main/Scripts/prizeweekday.user.js
// @updateURL    https://raw.githubusercontent.com/arbruffett/ignite-tampermonkey-scripts/refs/heads/main/Scripts/prizeweekday.user.js
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
(function () {
  ...
  function buildStandardHeaderTd(rValue) {
    ...
    // Edit Trigger (LINK on prizeweekday.php)
    ...
    // Integration Fields (LINK on prizeweekday.php)
    ...
    // Weekday Restrictions (TEXT, not link on this page)
    td.appendChild(makeText('Weekday Restrictions', '800'));
    td.appendChild(sep());
  ...
  function replacePrizeWeekdayHeader() {
