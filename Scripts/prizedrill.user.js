// ==UserScript==
// @name         prizedrill.php
// @match        https://beta.rewardsbutler.com/loy/prizedrill.php*
// @author       arbruffett
// @namespace    https://github.com/arbruffett/ignite-tampermonkey-scripts
// @version      1.0.0
// @downloadURL  https://raw.githubusercontent.com/arbruffett/ignite-tampermonkey-scripts/refs/heads/main/Scripts/prizedrill.user.js
// @updateURL    https://raw.githubusercontent.com/arbruffett/ignite-tampermonkey-scripts/refs/heads/main/Scripts/prizedrill.user.js
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
(function () {
  ...
  function insertTriggerNavRowBelowHeader(headerTr) {
    ...
    // Trigger Search (LINK on this page)
    navTd.appendChild(makeLink('prizes.php', 'Trigger Search'));
    navTd.appendChild(sep());

    // New Trigger (TEXT on this page)
    navTd.appendChild(document.createTextNode('New Trigger'));
    navTd.appendChild(sep());

    // Other links
    navTd.appendChild(makeLink('combosLocationFilter.php', 'Combos'));
    navTd.appendChild(sep());
